...
variable "vm_ip_cidr" {
  description = "Static IP in CIDR notation (e.g. 192.168.255.243/28)"
  type        = string
}

variable "vm_gateway" {
  description = "Default gateway for the LAN Cloud network"
  type        = string
}

variable "network_bridge" {
  description = "Proxmox bridge for LAN Cloud network"
  type        = string
  default     = "vmbr1"
}
